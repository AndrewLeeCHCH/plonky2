...
use crate::proof::{StarkProof, StarkProofWithPublicInputs, StarkOpeningSet};
...
impl Buffer {
    ...
    pub fn write_stark_proof<F: RichField + Extendable<D>, C: GenericConfig<D, F = F>, const D: usize>(
        &mut self,
